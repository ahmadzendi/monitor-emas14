...
from fastapi import FastAPI, WebSocket, WebSocketDisconnect, Response, HTTPException, Query, Request
...
.card-calendar{width:100%;height:450px;overflow:hidden;display:flex;flex-direction:column}
...
.calendar-iframe{border:0;width:100%;flex:1;min-height:420px;display:block}
...
.calendar-iframe{min-height:390px}
...
.card-calendar{height:380px}
.calendar-iframe{min-height:350px}
